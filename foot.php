<div id="eys-footer">
  <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; padding: 1rem;">
    <div style="flex: 1;">
      <ul style="list-style: none; margin: 0; padding: 0;">
        ...
        <li><a href="https://twitter.com/home?lang=es" class="icon fa-twitter" target="_blank" title="Twitter"><span class="label">Asesoría técnica</span></a></li>
